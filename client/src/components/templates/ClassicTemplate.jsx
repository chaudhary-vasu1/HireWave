                                ...
                                <div key={index} className="mb-4">
                                    <div className="flex justify-between">
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-blue-800">
                                            {project.link && (
                                                <a href={formatUrl(project.link)} target="_blank" rel="noopener noreferrer" className="hover:underline">
                                                    {project.link}
                                                </a>
                                            )}
                                            {project.link && project.github && <span className="text-gray-500">|</span>}
                                            {project.github && (
                                                <a href={formatUrl(project.github)} target="_blank" rel="noopener noreferrer" className="hover:underline text-gray-800">
                                                    {project.github}
                                                </a>
                                            )}
                                        </div>
