            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-sky-500" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    >
      ...
      <Title
        ...
        description="Hear what out users say about us We're always looking for ways to improve. If you have a positive experience with us, Leave us a review."
      />
    </div>
