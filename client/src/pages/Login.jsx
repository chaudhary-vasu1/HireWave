  ...
  return (
    <div className='min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-100 via-slate-50 to-indigo-100 flex items-center justify-center p-4'>
      ...
      >
        ...
        <button 
          type="submit" 
          className="mt-6 w-full h-11 rounded-xl text-white font-medium bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 shadow-md shadow-sky-500/25 active:scale-[0.98] transition-all cursor-pointer text-sm"
        >
        ...
        <p 
          ...
          className="text-slate-500 text-xs mt-5 cursor-pointer font-medium hover:text-slate-700 transition-colors"
        >
